...
public class Room3 extends javax.swing.JFrame {
    ...
    public Room3() {
        initComponents();
        asientosDisponibles.setText(String.valueOf(Principal.salas.get(2).getCantidadAsientos()));
        if(Principal.salas.get(2).getObraSala() == null){
            
        } else {
            obraAsignada.setText(String.valueOf(Principal.salas.get(2).getObraSala()));
        }
    }
